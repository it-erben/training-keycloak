...
$KEYCLOAK_CALLBACK = "http://localhost:9090/realms/mustertech/broker/gitea/endpoint"
...
try {
    docker exec demo-gitea gitea admin user create `
...
Write-Host "    Token URL:         http://demo-gitea:3000/login/oauth/access_token"
Write-Host "    User Info URL:     http://demo-gitea:3000/login/oauth/userinfo"
