...
3. Melde dich mit einem bestehenden User an
...
1. Öffne ein **Inkognito-Fenster**
2. Melde dich in der Account Console an: <http://localhost:8080/realms/mustertech/account>
...
1. Navigiere zu **Realm settings** → **Sessions**
2. Setze **SSO Session Max** zurück auf **10 Stunden**
3. Klicke auf **Save**
