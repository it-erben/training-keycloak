...
- Mindestens ein User vorhanden (z.B. aus Modul 04)
...
1. Gib Username und Passwort eines bestehenden Users ein
...
2. Wähle den Flow **browser** (Original)
3. **Action** → **Bind flow** → **Browser flow** → **Save**
4. Optional: Flow **Browser mit MFA** löschen (⋮ → Delete)
5. Falls ein User OTP eingerichtet hat:
   - **Users** → User öffnen → **Credentials** → OTP-Credential löschen
