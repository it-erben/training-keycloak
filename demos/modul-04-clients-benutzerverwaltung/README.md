...
```bash
curl -X POST http://localhost:8080/realms/mustertech/protocol/openid-connect/token \
...
Falls gewünscht, nach der Demo:

1. User **alice** löschen
2. Clients **wiki-app**, **chat-app**, **batch-service** löschen
3. Realm Role **Team-Lead** löschen
4. Gruppe **Engineering** löschen
5. User-Profile-Attribut **department** löschen (Realm settings → User profile)
