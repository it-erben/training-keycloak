...
- [ ] Modul 09 abgeschlossen
- [ ] Smartphone mit Authenticator-App (Google Authenticator, Microsoft Authenticator, Authy, etc.)

Falls nicht, nutze den Checkpoint von Modul 09.

---

## Teil 1: Passwort-Policies konfigurieren

Passwort-Policies erzwingen sichere Passwörter bei der Registrierung und beim Ändern.
...
**Erwartetes Ergebnis:** Fehlermeldung, dass das Passwort die Policy nicht erfüllt.
...
**Erwartetes Ergebnis:** Nach 5 Fehlversuchen erscheint eine Meldung, dass der Account temporär gesperrt ist.
...
Für die Entwicklung kannst du kürzere Werte verwenden, um das Verhalten zu testen:
...
**Admin-Tipp:** Bei einem Sicherheitsvorfall kannst du hier alle Sessions beenden, um alle User auszuloggen.
