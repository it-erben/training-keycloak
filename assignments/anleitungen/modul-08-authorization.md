...
- [ ] Modul 06b abgeschlossen (Portal-API läuft)
...
## Teil 7: API Integration — Permissions live erleben
...
2. Füge beim Service **portal-api** eine Zeile hinzu:
...
> **Erkenntnis:** Kein Rebuild, kein Redeploy, kein Code-Change. Die Zugriffsentscheidung liegt komplett in Keycloak.
